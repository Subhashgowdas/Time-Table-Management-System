    ...
    <div id="TT" style="background-color: #FFFFFF">
        <table border="2" cellspacing="3" align="center" id="timetable">
            ...
            <tr>
                ...
                <td style="text-align:center">8:00-8:55</td>
                <td style="text-align:center">8:55-9:50</td>
                <td style="text-align:center">9:50-10:45</td>
                <td style="text-align:center">11:00-12:00</td>
                <td style="text-align:center">12:00-1:00</td>
                <td style="text-align:center">1:00-2:00</td>
                <td style="text-align:center">2:00-2:55</td>
                <td style="text-align:center">2:55-3:50</td>
                <td style="text-align:center">3:50-4:45</td>
            </tr>
            <tr>
                <?php
                $table = null;
                ...
                <td style=\"text-align:center\">{$row['period3']}</td>
                 <td style=\"text-align:center\">{$row['period4']}</td>
                  ...
                  <td style=\"text-align:center\">{$row['period8']}</td>
                    ...
                    echo '</table>';
                    $sign = "GENERATED VIA TIMETABLE MANAGEMENT SYSTEM, COMPUTER SCIENCE AND ENGINEERING DEPARTMENT,KVGCE.";
