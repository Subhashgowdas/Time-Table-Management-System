            ...
            <div style="display:none" id="addSubjectForm">
                <form action="addsubjectFormValidation.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="subjectcode" name="SC" placeholder="18CS  18CSL...">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="subjectdepartment" name="SD">
                            ...
                            <option value="Electrical and Electronics Engg.">Electronics  and Electronics Engg.</option>
