...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">TIME TABLE MANAGEMENT SYSTEM, COMPUTER SCIENCE AND ENGINEERING DEPARTMENT</h3>
        </div>
    </div>
</div>
...
<div align="center">
    <form data-scroll-reveal="enter from the bottom after 0.2s" action="studentvalidation.php" method="post">
        ...
        <button type="submit" class="btn btn-info btn-lg" style="margin-top: 10px">Display</button>
    </form>
</div>
<!-- The Modal -->
...
<div class="container">
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <h2><strong>Our Location </strong></h2><h4><a href="http://kvgengg.com/About">About College</a></h4>
            <h4><a href="https://www.bing.com/maps?q=kvgce+sullia+engineering+college+location&qs=HS&pq=kvgce+sullia+engineering+college+location&sc=1-41&cvid=CBA35903734444FDB5E8C44087EE2200&FORM=QBRE&sp=1">College Location</a></h4>
            <hr/>
            <div>
                <h4>Find Us Anywhere,
                </h4>
                <h4><a href="http://kvgengg.com/About">College Home Page</a></h4>
                <h4><a href="https://collegedunia.com/college/13951-kvg-college-of-engineering-kvgce-sullia/admission">College Addmission</a></h4>
                <h4><strong>Call:</strong> 08257231141 </h4>
                <h4><strong>Email: </strong>kvgce@gmail.com</h4>
            </div>
